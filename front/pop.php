    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td><?=$row['good'];?>個人說<img src="img/02B03.jpg" style="width:30px">
                    ...
                    if (!empty($_SESSION['login'])) {
                        ...
                        if ($chk == 0) {
                    ?>
                            <a href="#" onclick="good('<?= $row['id']; ?>','1','<?= $_SESSION['login']; ?>')" id="good<?= $row['id']; ?>">讚</a>
                        <?php
                        } else {
                        ?>
                            <a href="#" onclick="good('<?= $row['id']; ?>','2','<?= $_SESSION['login']; ?>')" id="good<?= $row['id']; ?>">收回讚</a>
